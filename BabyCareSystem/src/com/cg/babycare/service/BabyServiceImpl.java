...
public class BabyServiceImpl implements IBabyService
{
	 ...
	 public void validateBaby1(BabySittingService babySittingService) throws BabyCareException
	 {
	 	List<String> validationErrors3 = new ArrayList<String>();
	 	
	 	
	 	if(!(isValidName(babySittingService.getBabyName())))
	 				 
	 	{
	 		validationErrors3.add("\n Baby Name Should Be In Alphabets and minimum 3 characters long ! \n");
	 	}
	 	...
	 	{
	 		validationErrors3.add("\n Address Should Be 10characters long \n");
	 	}
	 			
	 	
	 	if(!(isValidContact(babySittingService.getContact())))
	 	{
	 		validationErrors3.add("\n Contact Should be 10 digits long and should start with 6-9 \n");
	 	}
	 	
	 	
	      if(!validationErrors3.isEmpty())
	 	{
	 		throw new BabyCareException(validationErrors3 +"");
	     }
	 }
	 ...
	 {    String baby_gender= String.valueOf(gender);
	 ...
	 private boolean isValidAge(String babyAge) 
	...
	public String addDetails(BabySittingService baby1) throws ClassNotFoundException, FileNotFoundException, SQLException {
		babyDao=(IBabyDao) new BabyDaoImpl();	
 		String babySeq2;
 		babySeq2= babyDao.addDetails(baby1);
 		return babySeq2; 
	}
