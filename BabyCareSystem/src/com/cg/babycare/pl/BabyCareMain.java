...
public class BabyCareMain 
{
	...
	public static void main(String[] args) throws ClassNotFoundException, FileNotFoundException, SQLException {
		...
		BabySittingService babySittingService=null;
	    String proId;
        String proName=null;
		String babyId = null;
		...
		while (true) 
		{
			...
			System.out.println("3.Baby Sitting Service");
			...
			try 
			{
				...
				case 3:
					...
					while (babySittingService == null) 
						{   
							
						babySittingService = populateBabySittingService();
						...
						{
							babyService = new BabyServiceImpl();
							proId = babyService.addDetails(babySittingService);

							System.out.println("Baby Details  has been successfully registered ");
							System.out.println("Baby Sitter Id is: " + babySitterId);
	...
	private static BabySittingService populateBabySittingService() 
	{
		BabySittingService babySittingService = new BabySittingService();
		System.out.println("\n Enter Details");
		
		
		System.out.println("Baby Name: ");
		babySittingService.setBabyName(sc.next());
		
		System.out.println("Baby Age:");
		babySittingService.setBabyAge(sc.next());

		System.out.println("Baby Gender: ");
		babySittingService.setBabyGender(sc.next());

		System.out.println("Father's Name: ");
		babySittingService.setFatherName(sc.next());

		System.out.println("Mother's Name: ");
		babySittingService.setMotherName(sc.next());

		System.out.println("Address: ");
		babySittingService.setAddress(sc.next());
		

		System.out.println("Contact: ");
		babySittingService.setContact(sc.next());
		
		babyServiceImpl = new BabyServiceImpl(); 
		try 
		{
			babyServiceImpl.validateBaby1(babySittingService);
